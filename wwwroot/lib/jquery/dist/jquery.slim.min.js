...
!(function (e, t) {
	...
	!(function () {
		...
		function Y(e, t) {
			...
			(a = e), (s = []), (u = x.preFilter);
			while (a) {
				for (o in ((n && !(r = y.exec(a))) || (r && (a = a.slice(r[0].length) || a), s.push((i = []))), (n = !1), (r = m.exec(a)) && ((n = r.shift()), i.push({ value: n, type: r[0].replace(ve, " ") }), (a = a.slice(n.length))), x.filter)) !(r = N[o].exec(a)) || (u[o] && !(r = u[o](r))) || ((n = r.shift()), i.push({ value: n, type: o, matches: r }), (a = a.slice(n.length)));
				if (!n) break;
			}
	...
	(ce.event = {
		...
		add: function (t, e, n, r, i) {
			...
			if (F(t)) {
				...
				while (l--) (p = g = (s = De.exec(e[l]) || [])[1]), (h = (s[2] || "").split(".").sort()), p && ((f = ce.event.special[p] || {}), (p = (i ? f.delegateType : f.bindType) || p), (f = ce.event.special[p] || {}), (c = ce.extend({ type: p, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && ce.expr.match.needsContext.test(i), namespace: h.join(".") }, o)), (d = u[p]) || (((d = u[p] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(t, r, h, a)) || (t.addEventListener && t.addEventListener(p, a))), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, c) : d.push(c), (ce.event.global[p] = !0));
			}
		},
